...
source /home/val/anaconda3/etc/profile.d/conda.sh
...
python main.py --train_file ./data/beans_train.csv --test_file ./data/test_public.csv --prediction_file ./data/predictions.csv
